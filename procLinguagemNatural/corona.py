# -*- coding: utf-8 -*-
"""
Created on Tue May 10 09:16:53 2022
...
complete_data=pd.read_table("Corona_NLP.csv", encoding='latin-1', sep=',')
...
entrada = input("Digite uma frase para a classificação: ")

sentence = [(entrada, 'None')]
...
for (f, c) in frase:
    print("Classificação:",classificador.classify(f))
